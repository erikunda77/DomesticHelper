...
<h2 class="text-center" style="margin-top: 20px">online domestic helper provider </h2>
<hr>
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
                ...
                <option value="plumber">cooker</option>
                <option value="mobile">baby sitter</option>
                <option value="mobile">elder care</option>
                 <option value="mobile">home guards</option>
            </select>
        </div>
